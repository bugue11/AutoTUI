class CustomController extends ZCustomComponent {
    ...
    onCmdOk_click() {
        zPost("cambiaPwd.seg", {zToken:window.zSecurityToken, sesion : window.app.sesion.usuario, pwd:this.edPwd.val.trim(), pwd1:this.edPwd1.val.trim(), pwd2:this.edPwd2.val.trim()})
            .then(() => {
